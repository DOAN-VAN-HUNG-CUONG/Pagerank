...
Each cell is \emph{wall-clock time (s)\,/\,peak memory (MB)}. Measured in the
CI container.}
\label{tab:perf}
...
\midrule
Core (Python)    & 0.12 / 13.4 & 0.67 / 18.4 & 0.87 / 24.6 \\
mrjob (core)     & 0.21 / 24.5 & 1.05 / 29.2 & 1.14 / 35.5 \\
Hadoop Streaming & 1.57 / \phantom{0}9.6 & 3.41 / 11.6 & 7.56 / 13.9 \\
\bottomrule
\end{tabular}
\end{table}
